...
export default function MacbookModel16(props) {
  ...
  const { nodes, materials, scene } = useGLTF('https://3d-cdn.drninja.net/macbook-16-transformed.glb')
...
useGLTF.preload('https://3d-cdn.drninja.net/macbook-16-transformed.glb')